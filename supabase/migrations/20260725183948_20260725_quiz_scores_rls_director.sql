/*
# Fix quiz_scores RLS — add director role to insert/update

Directors can manage quiz scores for their assigned committees,
matching the same pattern used for task_grades.
*/
